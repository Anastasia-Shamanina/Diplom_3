...
public class LoginButtonsAtPage {
    ...
    public void clickRrestoreLoginButton() {
    ...
    private boolean isDisplayed(By createOrderButton) {
        return true;
    }
    public void displayedCreateOrderButton() {
        new WebDriverWait(driver, 3)
                .until(ExpectedConditions.visibilityOfElementLocated(createOrderButton));
        assertEquals(isVisible, isDisplayed(createOrderButton));
    }
